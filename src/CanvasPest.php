<?php
    ...
    class CanvasPest extends \Battis\Educoder\Pest
    {
         ...
         **/
        public function __construct(string $apiInstanceUrl, $apiAuthorizationToken = null)
        {
         ...
         *
         * This function adds a 'User-Agent' header which can be customized using an ENv
         *
        ...
        {
            $user_agent = getenv('CANVASPEST_USER_AGENT') ?: 'CanvasPest-AA/1.0';
